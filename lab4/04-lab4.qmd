...
if(exists("ego_avr") && !is.null(ego_avr)) {
  # Visualize with a dotplot
  p_enrich <- enrichplot::dotplot(ego_avr, showCategory=20) + 
              ggplot2::ggtitle("GO Enrichment: Avirulent Response (Up-regulated)")
  print(p_enrich)
} else {
  print("GO Enrichment data not found or no significant genes to enrich.")
}
```
