...
- Start a new R Markdown file named `lab5_metagenomics.Rmd`
...
```{r dl2, echo=FALSE, results='hide', message=FALSE,warning=FALSE}
...
```{r install and load dada2, echo = TRUE, eval = F, message=FALSE}
...
```{r read fastq files forward and reverst, include = TRUE, echo = TRUE, eval = TRUE, message=FALSE}
...
```{r q forward reads, echo = TRUE, out.width = '100%', fig.align = 'center'}
...
```{r Q reverse reads, echo = TRUE, out.width = '100%', fig.align = 'center'}
...
```{r filtering through files, echo = TRUE}
...
```{r how much was lost 1, echo=TRUE}
...
```{r visualizing Error for F, echo = TRUE, eval = TRUE, warning=FALSE}
...
```{r sample inference F, echo = TRUE}
...
```{r inspecting, echo = TRUE, eval = TRUE}
dadaFs[[1]]
```
...
```{r merging reads, echo = TRUE, eval = TRUE, message=FALSE}
...
```{r remove chimeras, echo = TRUE, eval = TRUE}
...
```{r imock accuracy, echo = TRUE, eval = TRUE}
...
```{r data frame, echo = TRUE, eval = TRUE}
...
```{r construct phyloseq, echo = TRUE, eval = TRUE}
...
```{r alpha diversity, echo = TRUE, eval = TRUE,warning=F}
...
```{r examin_richnes, echo = TRUE, eval = TRUE}
...
```{r ordinate, eval = TRUE, message=FALSE, out.width='100%'}
...
```{r bar plot, echo = TRUE, eval = TRUE, message=FALSE, out.width='100%'}
